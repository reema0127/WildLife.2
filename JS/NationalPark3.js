...
fetch ('NationalPark3.json')
    .then(response => response.json())
    .then(data => {
        sitedata.mainheading = data[0].mainheading;
        sitedata.site3 = data[0].site3;
        sitedata.para1 = data [0].para1;
        sitedata.para2 = data[0].para2;
        sitedata.para3 = data[0].para3;
        sitedata.para4 = data[0].para4;
        sitedata.galleryheading = data[1].galleryheading;
        table.tt1 = data[1].tt1;
        table.tt2 = data[1].tt2;
        table.tt3 = data[1].tt3;
        table.tt4 = data[1].tt4;
        table.animal1 = data[1].animal1;
        table.animal2 = data[1].animal2;
        table.animal3 = data[1].animal3;
        table.list1 = data[1].list1;
        table.smllist1 = data[1].smllist1;
        table.list2 = data[1].list2;
        table.list3 = data[1].list3;
        table.list4 = data[1].list4;
        table.smllist2 = data[1].smllist2;
        table.list5 = data[1].list5;
        table.list6 = data[1].list6;
        table.list7 = data[1].list7;
        table.smllist3 = data[1].smllist3;
        table.list8 = data[1].list8;
        table.list9 = data[1].list9;
        localStorage.setItem('Nationalpark3',JSON.stringify(data))
    }
    )
...
function openEditor1() {
    ...
    document.getElementById("editedSubtitle1").value = document.getElementById("site3").innerText;
...
function saveChanges1() {
    ...
    document.getElementById("site3").innerText = newSubtitle1;
